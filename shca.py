...
axf[3].pcolormesh(radardata['x0'],radardata['y0'],hidT[9,...],cmap=cmaphid,vmin=0,vmax=10)
axf[3].set_title(f'HCA at {z[9]} km')

axf[4].pcolormesh(radardata['x0'],radardata['y0'],hidT[12,...],cmap=cmaphid,vmin=0,vmax=10)
axf[4].set_title(f'HCA at {z[12]} km')

c = axf[5].pcolormesh(radardata['x0'],radardata['y0'],hidT[15,...],cmap=cmaphid,vmin=0,vmax=10)
